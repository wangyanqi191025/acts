...
PYBIND11_MODULE(ActsExamplesPythonBindingsRoot, root) {
  ...
  // Output
  {
    ...
    ACTS_PYTHON_DECLARE_WRITER(RootSeedWriter, root, "RootSeedWriter",
                               ...
                               treeName);
    ACTS_PYTHON_DECLARE_WRITER(RootSeedEventAnaWriter, root, "RootSeedEventAnaWriter", inputTrackParameters,
                               inputSimSeeds, inputSimHits,
                               inputMeasurementParticlesMap,
                               inputMeasurementSimHitsMap, outputDir, ROOTFileName,
                               fileMode, treeName);
