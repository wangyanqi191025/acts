...
ProcessCode GridTripletSeedingAlgorithm::execute(
  ...
  Acts::SpacePointContainer2 coreSpacePoints(
      Acts::SpacePointColumns::PackedXY | Acts::SpacePointColumns::PackedZR | Acts::SpacePointColumns::Time |
      Acts::SpacePointColumns::VarianceZ | Acts::SpacePointColumns::VarianceR | Acts::SpacePointColumns::VarianceT |
  ...
  bottomDoubletFinderConfig.applyTimeCut = m_cfg.useTimeCutMiddleBottomDoubletFinder;
  bottomDoubletFinderConfig.timeCutCoff = m_cfg.timeCoffMiddleBottomDoubletFinder;
  if (m_cfg.useExtraCuts) {
