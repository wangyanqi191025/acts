...
class RootSeedEventAnaWriter : public WriterT<TrackParametersContainer> {
 public:
  ...
  explicit RootSeedEventAnaWriter(const Config& config,Acts::Logging::Level level = Acts::Logging::INFO);
 ...
 private:
  ...
  ReadDataHandle<MeasurementSimHitsMap> m_inputMeasurementSimHitsMap{this, "InputMeasurementSimHitsMap"};
